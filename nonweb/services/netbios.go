...
func NetBIOS(info nonweb_utils.HostInfo) error {
...
func NetBIOS1(info nonweb_utils.HostInfo) (nbname NbnsName, err error) {
...
func GetNbnsname(info nonweb_utils.HostInfo) (nbname NbnsName, err error) {
