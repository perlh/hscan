...
import (
	...
	common_structs "hscan/web/pkg/common/structs"
	nuclei_structs "hscan/web/pkg/nuclei/structs"
...
func check(taskInterface interface{}) {
	...
	case *xray_structs.Task:
		...
		//log.Println(target, poc.Name, isVul)
		//if isVul {
		//	fmt.Printf("isvul")
		//}
...
func StartXray(target string, xrayPocMap map[string]xray_structs.Poc, outputChannel chan common_structs.Result) {
	// 设置outputChannel
	OutputChannel = outputChannel
	for _, poc := range xrayPocMap {
		WaitGroup.Add(1)
