...
func Inithttp(PocInfo poc_struct.PocInfoStruct) {
...
func InitHttpClient(ThreadsNum int, DownProxy string, Timeout time.Duration) error {
	...
	if common.RunningInfo.PocSocks5Proxy != "" {
		dialSocksProxy, err := utils.Socks5Dailer(dialer)
		if err != nil {
			return err
		}
